...
class BondedInteractions(Potential):
    ...
    def potential(self, system):
        ...
        for angle in self.angles:
            pot += Vangle(
                    pos[angle[2]],pos[angle[3]],pos[angle[4]],angle[0],angle[1]
                    )

        for dihedral in self.dihedrals:
            pot += Vdihedral(pos[dihedral[3]],pos[dihedral[4]],
                    pos[dihedral[5]],pos[dihedral[6]],dihedral[0],dihedral[1],
                    dihedral[2])
    ...
    def force(self, system):
        ...
        for dihedral in self.dihedrals:
            f1,f2,f3,f4 = Fdihedral(pos[dihedral[3]],pos[dihedral[4]],
                    pos[dihedral[5]],pos[dihedral[6]],dihedral[0],dihedral[1],
                    dihedral[2])
            force[dihedral[3],:] += -f1
            force[dihedral[4],:] += -f2
